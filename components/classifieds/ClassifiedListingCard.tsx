  ...
  return (
    ...
    >
      <div className={`relative overflow-hidden bg-[#eee8e2] ${compact ? 'aspect-[1.12/1]' : 'aspect-square sm:aspect-[4/3]'}`}>
        ...
        {listing.isFeatured && <span className="absolute left-2.5 top-2.5 rounded-full bg-[#2d211c]/90 px-2.5 py-1 text-[9px] font-black uppercase tracking-[.12em] text-white backdrop-blur sm:left-3 sm:top-3">Destaque</span>}
