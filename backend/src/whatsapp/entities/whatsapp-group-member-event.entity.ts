...
export class WhatsAppGroupMemberEvent {
  ...
  @Column({ type: 'varchar', length: 120, nullable: true }) memberWaId: string | null;
  @Column({ type: 'varchar', length: 120, nullable: true }) memberCanonicalId: string | null;
  @Column({ type: 'varchar', length: 120, nullable: true }) actorWaId: string | null;
