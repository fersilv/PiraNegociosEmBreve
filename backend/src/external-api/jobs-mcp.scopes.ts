...
export const JOBS_CAPABILITIES: JobsCapability[] = [
  ...
  {
    scope: 'jobs:list',
    category: 'Vagas · Consulta',
    label: 'Listar vagas',
    description: 'Lista vagas com filtros, paginação e estado operacional.',
    risk: 'read',
    defaultMcp: true,
  },
  {
    ...
    description: 'Lê os dados completos de uma vaga específica.',
    risk: 'read',
    defaultMcp: true,
  },
  {
    ...
    description: 'Consulta totais de vagas por atividade, moderação, revisão e alertas.',
    risk: 'read',
    defaultMcp: true,
  },
  {
    ...
    description: 'Pesquisa possíveis duplicidades antes de criar ou atualizar uma vaga.',
    risk: 'read',
    defaultMcp: true,
  },
  {
    ...
    category: 'Vagas · Consulta',
    label: 'Consultar perfil de aderência',
    description: 'Consulta schema e estado do mecanismo de compatibilidade de vagas.',
    risk: 'read',
    defaultMcp: true,
  },
  {
    scope: 'jobs:review:read',
    category: 'Vagas · Revisão',
    label: 'Consultar fila de revisão',
    description: 'Lista vagas pelo novo estado operacional de revisão.',
    risk: 'read',
    defaultMcp: true,
  },
  {
    scope: 'jobs:create',
    category: 'Vagas · Cadastro',
    label: 'Criar vaga',
    description: 'Cadastra nova vaga externa usando o fluxo normal de validação e deduplicação.',
    risk: 'write',
    defaultMcp: true,
  },
  {
    ...
    description: 'Atualiza conteúdo permitido de uma vaga existente.',
    risk: 'write',
    defaultMcp: true,
  },
  {
    scope: 'jobs:verify',
    category: 'Vagas · Revisão',
    label: 'Registrar verificação',
    description: 'Registra disponibilidade, fechamento, expiração, ausência ou incerteza da fonte.',
    risk: 'write',
    defaultMcp: true,
  },
  {
    ...
    description: 'Marca a vaga como revisada, para rechecagem, exigindo desativação ou resolvida.',
    risk: 'write',
  },
  {
    scope: 'jobs:activate',
    category: 'Vagas · Publicação',
    label: 'Ativar vaga',
    description: 'Ativa uma vaga para publicação e registra a decisão operacional.',
    risk: 'write',
  },
  {
    ...
    description: 'Desativa uma vaga e encerra o estado operacional pendente quando apropriado.',
    risk: 'destructive',
  },
  {
    scope: 'jobs:flag',
    category: 'Vagas · Alertas',
    label: 'Sinalizar vaga',
    description: 'Cria ou atualiza um alerta operacional na vaga.',
    risk: 'write',
  },
  {
    scope: 'jobs:unflag',
    category: 'Vagas · Alertas',
    label: 'Limpar alerta',
    description: 'Limpa o alerta sem devolver uma vaga já revisada para a fila de vagas novas.',
    risk: 'write',
  },
  {
    scope: 'jobs:delete',
    category: 'Vagas · Manutenção',
    label: 'Excluir vaga definitivamente',
    description: 'Remove definitivamente uma vaga. Deve ser liberado apenas para integrações administrativas confiáveis.',
    risk: 'destructive',
  },
];
