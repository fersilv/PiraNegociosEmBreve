CREATE TABLE IF NOT EXISTS whatsapp_oauth_clients (
...
CREATE TABLE IF NOT EXISTS whatsapp_oauth_codes (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE INDEX IF NOT EXISTS idx_whatsapp_oauth_codes_instance_client
  ON whatsapp_oauth_codes ("instanceId", "clientId");
...
CREATE INDEX IF NOT EXISTS idx_whatsapp_oauth_tokens_instance_client
  ON whatsapp_oauth_tokens ("instanceId", "clientId");
