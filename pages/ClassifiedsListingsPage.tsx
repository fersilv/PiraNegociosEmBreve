...
import { AlertTriangle, ArrowRight, BadgePercent, Loader2, Package, Plus, Wrench } from 'lucide-react';
  ...
  return (
    <div className="mx-auto max-w-7xl space-y-6">
      <header className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        <div><p className="text-[10px] font-black uppercase tracking-[.18em] text-[#b06448]">Sua vitrine</p><h1 className="mt-1 font-serif text-3xl font-black">{products ? 'Meus anúncios' : 'Meus serviços'}</h1><p className="mt-2 max-w-2xl text-sm leading-6 text-stone-500">{products ? 'Produtos publicados, rascunhos, pausados e vendidos ficam organizados aqui. Preço normal, promoção e condições de pagamento podem ser ajustados em Comercial.' : 'Gerencie separadamente os serviços que você oferece nos Classificados.'}</p></div>
