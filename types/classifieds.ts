...
export interface ClassifiedOffer {id:string;listingId:string;buyerUserId:string;buyerCompanyId?:string|null;sellerUserId:string;sellerCompanyId?:string|null;amount:string|number;status:ClassifiedOfferStatus;expiresAt:string;respondedAt?:string|null;createdAt:string;updatedAt:string;role:'BUYER'|'SELLER';title:string;slug:string;price?:string|number|null;priceType?:ClassifiedPriceType;listingStatus?:ClassifiedListingStatus;image?:string|null;buyerName?:string;sellerName?:string}
...
export interface ClassifiedCommerceStatus {business:boolean;companyId?:string;companyVerified?:boolean;onlineSalesAvailable:boolean;plan:string;feeRule:ClassifiedCommerceFeeRule|null;paymentConnections:Array<{provider:'MERCADO_PAGO'|'EFI'|string;status:string;externalUserId?:string|null;tokenExpiresAt?:string|null;connectedAt?:string|null;updatedAt?:string|null}>}
