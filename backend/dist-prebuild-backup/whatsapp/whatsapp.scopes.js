...
exports.DEFAULT_WHATSAPP_SCOPES = exports.WHATSAPP_SCOPES = exports.WHATSAPP_CAPABILITIES = void 0;
exports.sanitizeWhatsAppScopes = sanitizeWhatsAppScopes;
exports.getWhatsAppCapability = getWhatsAppCapability;
const whatsapp_operations_catalog_1 = require("./whatsapp-operations.catalog");
const LEGACY_WHATSAPP_CAPABILITIES = [
...
const CUSTOM_WHATSAPP_CAPABILITIES = [
    {
        scope: 'groups:reply',
...
exports.WHATSAPP_CAPABILITIES = [
    ...LEGACY_WHATSAPP_CAPABILITIES,
    ...CUSTOM_WHATSAPP_CAPABILITIES,
    ...whatsapp_operations_catalog_1.WPP_OPERATION_CAPABILITIES.map((capability) => ({ ...capability, legacy: false })),
];
exports.WHATSAPP_SCOPES = exports.WHATSAPP_CAPABILITIES.map((capability) => capability.scope);
exports.DEFAULT_WHATSAPP_SCOPES = [
    'connection:read',
    'messages:read',
    'contacts:read',
    'groups:read',
];
function sanitizeWhatsAppScopes(value) {
    if (!Array.isArray(value))
        return [...exports.DEFAULT_WHATSAPP_SCOPES];
    const allowed = new Set(exports.WHATSAPP_SCOPES);
    return Array.from(new Set(value.map(String).filter((scope) => allowed.has(scope))));
}
function getWhatsAppCapability(scope) {
    return exports.WHATSAPP_CAPABILITIES.find((capability) => capability.scope === scope) || null;
}
//# sourceMappingURL=whatsapp.scopes.js.map