...
import { MessageCircle, ShieldCheck, Store, User } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-[#f7f5f2] text-stone-900">
      <SeoHead
        ...
        description="Regras específicas para compra, venda, prestação de serviços e negociação nos Classificados PiraNegócios."
      ...
      <main className="mx-auto max-w-4xl px-4 py-10 sm:px-6 sm:py-14">
        <div className="rounded-[32px] bg-white p-6 shadow-sm ring-1 ring-black/[.06] sm:p-10">
          ...
          <div className="mt-9 space-y-8 text-sm leading-7 text-stone-700">
            ...
            <Term number="8" title="Preço, pagamento, entrega e contratação">
              As condições finais são definidas entre as partes. Antes de pagar ou entregar um bem, confira identidade, estado do produto, escopo do serviço, valor, forma de pagamento e condições de entrega ou retirada. Recursos futuros de pagamento, pedido ou proposta poderão possuir regras complementares próprias.
            </Term>
            <Term number="9" title="Página pública da empresa">
            ...
            <Term number="10" title="Moderação, denúncias e segurança">
            ...
            <Term number="11" title="Atualizações destes termos">
