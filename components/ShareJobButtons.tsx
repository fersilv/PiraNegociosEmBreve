    ...
    <>
      <div className="flex flex-wrap gap-2 mt-4">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="flex items-center gap-2 px-3 py-2 bg-[#1877F2] hover:bg-[#166fe5] text-white rounded-lg text-sm font-bold transition-colors shadow-sm"
        >
        ...
        <button
          ...
          className="flex items-center gap-2 px-3 py-2 bg-stone-800 hover:bg-stone-900 text-white rounded-lg text-sm font-bold transition-colors shadow-sm ml-auto"
        >
